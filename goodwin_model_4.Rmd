...
df_2019 <- cbind(econ_2019, health_2019[, c(1:2)], health_2019_Inc[,c(6)])
...
# 2019 Values and Comparison
```{r predicting and modeling 2019 data}
 
# Comparing Models Using 2019 Values
# Model 1 with 2019 Data
ModelMetrics::rmse(lm(df_2019$Data ~ df_2019$...47 + df_2019$IncomeLevel + df_2019$`Proportion of seats held by women in national parliaments (%)`))
AIC(lm(df_2019$Data ~ df_2019$...47 + df_2019$IncomeLevel + df_2019$`Proportion of seats held by women in national parliaments (%)`))
summary(lm(df_2019$Data ~ df_2019$...47 + df_2019$IncomeLevel + df_2019$`Proportion of seats held by women in national parliaments (%)`))

ModelMetrics::rmse(lm(df_2019$Data ~ df_2019$...47 + df_2019$IncomeLevel  + df_2019$`Domestic general government health expenditure per capita (current US$)`))
AIC(lm(df_2019$Data ~ df_2019$...47 + df_2019$IncomeLevel  + df_2019$`Domestic general government health expenditure per capita (current US$)`))
summary(lm(df_2019$Data ~ df_2019$...47 + df_2019$IncomeLevel  + df_2019$`Domestic general government health expenditure per capita (current US$)`))
