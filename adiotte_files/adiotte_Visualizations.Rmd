...
ggsave("trendprevalence.png", width = 8, height = 6, dpi = 150, units = "in", device='png')
```
...
ggplot(df,
  ...
  theme(title = element_text(size=18), 
        ...
        legend.title = element_text(size=16), 
        legend.text = element_text(size=14))
ggsave("trendincidence.png", width = 8, height = 6, dpi = 150, units = "in", device='png')
```
...
ggplot(df, aes(x = year, y = Avg)) + 
  ...
  theme(title = element_text(size=18), 
        ...
        legend.title = element_text(size=16), 
        legend.text = element_text(size=14))
ggsave("trenddeaths.png", width = 8, height = 6, dpi = 150, units = "in", device='png')
```
...
ggsave("mapprevalence.png", width = 10, height = 6, dpi = 150, units = "in", device='png')
```
...
ggplot(data = df_all, aes(x = year, y = Data, fill = Location)) +
  ...
  theme(title = element_text(size=18), 
        ...
        legend.title = element_text(size=16), 
        legend.text = element_text(size=14))
ggsave("top5prevalence.png", width = 10, height = 8, dpi = 150, units = "in", device='png')
```
...
ggplot(diabetes.rate.map, aes(long, lat, group = group)) +
  ...
  theme(
    ...
    legend.title = element_text(size = 16, hjust = 0.5),
    text = element_text(size = 16))
ggsave("mapincidence.png", width = 10, height = 6, dpi = 150, units = "in", device='png')
```
...
ggplot(data = df_all, aes(x = year, y = Data, fill = Location)) +
  ...
  theme(title = element_text(size=18), 
        ...
        legend.title = element_text(size=16), 
        legend.text = element_text(size=14))
ggsave("top5incidence.png", width = 10, height = 8, dpi = 150, units = "in", device='png')
```
...
ggplot(diabetes.rate.map, aes(long, lat, group = group)) +
  ...
  theme(
    ...
    legend.title = element_text(size = 16, hjust = 0.5),
    text = element_text(size = 16))
ggsave("mapdeaths.png", width = 10, height = 6, dpi = 150, units = "in", device='png')
```
...
ggplot(data = df_all, aes(x = year, y = Data, fill = Location)) +
  ...
  theme(title = element_text(size=18), 
        ...
        legend.title = element_text(size=16), 
        legend.text = element_text(size=14))
ggsave("top5deaths.png", width = 10, height = 8, dpi = 150, units = "in", device='png')
```
