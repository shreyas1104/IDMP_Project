...
```{r}
health <- na.omit(read.csv("../Datasets/HealthData.csv"))
incident.prevalence <- na.omit(read.csv("../Datasets/IncidencePrevalence.csv"))
locationCodes <- data_frame(na.omit(read.csv("../Datasets/All Locations Hierarchies-Table 1.csv")))
...
```{r} 
WB_DBI <- na.omit(read.csv("../Datasets/WB_WDI.csv"))
